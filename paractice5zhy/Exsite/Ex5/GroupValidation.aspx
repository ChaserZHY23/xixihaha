...
<body>
    ...
    <div>
        ...
        <table class="auto-style1">
            <tr>
                ...
                <td>
                    ...
                    <asp:Label ID="IbIName" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="rfvPassword" runat="server" ClientIDMode="Static" ControlToValidate="txtPassword" Display="Dynamic" ErrorMessage="请输入密码！" SetFocusOnError="True">*</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
        ...
        <asp:Button ID="btnSubmit" runat="server" OnClick="btnSubmit_Click" Text="确定" ValidationGroup="groupSubmit" />
