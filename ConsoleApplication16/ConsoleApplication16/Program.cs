...
namespace _7_2
{
    public partial class Form1 : Form
    {
        ...
        private void 打开ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            openFileDialog.Filter = "Bitmap 文件（*.bmp）|*.bmp|Jpeg 文件(*.jpg)|*.jpg|所有合适文件（*.bmp/*.jpg）|*.bmp/*.jpg";
        ...
        private void 保存ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialog.Filter = "Bitmap 文件（*.bmp）|*.bmp|Jpeg 文件(*.jpg)|*.jpg|所有合适文件（*.bmp/*.jpg）|*.bmp/*.jpg";
