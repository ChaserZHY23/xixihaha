...
public partial class Order : INotifyPropertyChanging, INotifyPropertyChanged
{
    ...
    partial void OnAdde1Changing(string value);
    partial void OnAdde1Changed();
    partial void OnAddr2Changing(string value);
    partial void OnAddr2Changed();
    partial void OnCityChanging(string value);
    partial void OnCityChanged();
	...
	[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Adde1", DbType="NVarChar(80)")]
	public string Adde1
	{
		get
		{
		...
		set
		{
			if ((this._Adde1 != value))
			{
				this.OnAdde1Changing(value);
				this.SendPropertyChanging();
				this._Adde1 = value;
				this.SendPropertyChanged("Adde1");
				this.OnAdde1Changed();
			}
		}
	}
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Order_OrderItem", Storage="_OrderItem", ThisKey="OrderId", OtherKey="OderId")]
...
public partial class OrderItem : INotifyPropertyChanging, INotifyPropertyChanged
{
    ...
    partial void OnOderIdChanging(int value);
	...
	[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_OderId", DbType="Int NOT NULL")]
	public int OderId
	{
		get
		{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Order_OrderItem", Storage="_Order", ThisKey="OderId", OtherKey="OrderId", IsForeignKey=true)]
	public Order Order
	{
		get
		{
		...
		set
		{
						...
						|| (this._Order.HasLoadedOrAssignedValue == false)))
			{
				...
				if ((value != null))
				{
					...
					this._OderId = value.OrderId;
				}
				else
				{
					this._OderId = default(int);
				}
